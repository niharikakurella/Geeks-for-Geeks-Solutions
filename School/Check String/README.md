<h2><a href="https://www.geeksforgeeks.org/problems/check-string1818/1?utm_source=geeksforgeeks&utm_medium=ml_article_practice_tab&utm_campaign=article_practice_tab">Check String</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string, check if all its characters are the same or not.</span></p>
