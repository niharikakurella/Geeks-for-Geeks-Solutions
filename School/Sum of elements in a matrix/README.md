<h2><a href="https://practice.geeksforgeeks.org/problems/sum-of-elements-in-a-matrix2000/0">Sum of elements in a matrix</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a non null integer matrix Grid of dimensions NxM.Calculate the sum of its elements.</span></p>
